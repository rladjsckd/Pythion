...
# print(0o10) # 8진수 10울 10진수로 표현
# print(0xb)  # 16진수 b를 10잔수로 표현
...
# print(r"C:\Python1\source") = print("C:\\Python1\\source")
# 경로를 나타내는 문자열은 r을 통하여 \ 한번만 쓸수 있다.

# # 장문의 문자열 표현
# # 삼겹따옴표 [""" """] 또는 [''' ''']를 통하여 잔문의 문자열을 관리할 수있다.
# Message = '''안녕하세요
# 안동대학교
# 스마트팩토리 파이썬 수업입니다.
# '''
...
#################################
# a = ord('a') # 문자 'a'와 코드 값을 a 변수에 할당
# b = chr(97) # 10진 코드값 97을 문자로 변환하여 표현
# print(a)
# print(b)
...
# d = chr(0b1100001)# 2진수를 변환 97
# print(d)

####################################
# # 진위 형 True/False
# # 참과 거짓을 1과 0으로 표현. 가독성이 좋은(코드를 보기 쉽다) 코드를 구현하기 쉽다.
...
# # 진위 형의 활용
# a = 5 # a가 5값을 할당 받는다
# b = a == 5 # a가 5값을 가지고 있으므로 b는 True를 할당 받는다.
# print(b)

# MyClass mc = new MyClass(); 객체지향의 예시
...
# # 
# # - 리스트
# #  . 동일한 데이터 유형의 값을 하나의 잡합으로 묶어 특정 변수에 할당하는 형태
# #  . 데이터를 변경 할 수 있다.
####################################
# # 리스트의 생성과 사용
#           0      1      2     3 
